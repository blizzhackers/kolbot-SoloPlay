...
(function (factory) {
  ...
  "use strict";
  if (!isIncluded("libs/SoloPlay/Core/PatherOverrides.js")) { include("libs/SoloPlay/Core/PatherOverrides.js"); }
  include("SoloPlay/Core/ClassAttackOverrides/" + sdk.player.class.nameOf(me.classid) + "Attacks.js");

...
var build = {
	...
	autoEquipTiers: [ // autoequip final gear
		...
		"[name] == grandcharm && [quality] == magic # [bowandcrossbowskilltab] == 1 # [invoquantity] == 1 && [charmtier] == 1000 + charmscore(item)",
		"[name] == grandcharm && [quality] == magic # [passiveandmagicskilltab] == 1 # [invoquantity] == 1 && [charmtier] == 1000 + charmscore(item)",
		//Switch

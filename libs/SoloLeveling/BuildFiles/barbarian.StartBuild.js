...
var build = {
	...
	skills: [
		/*[126, 2, false], // Bash 2 // -> charlvl 3
		[127, 2, false], // Sword Mastery 2 // -> charlvl 4
		[130, 1, false], // Howl 1 // -> charlvl 5
		[133, 1, false], // Double Swing 1 // -> charlvl 6
		[138, 1, false], // Shout 1 // -> charlvl 7
		[133, 9, false], // Double Swing 9 // -> charlvl 16
		[146, 1, false], // Battle Cry 1 // -> charlvl 18
		[145, 1, false], // Iron Skin 1 // -> charlvl 19
		[126, 6, false], // Bash 6 // -> charlvl 23
		[149, 1, false], // Battle Orders 1 // -> charlvl 24
		[126, 20, true], // Bash 20 // -> charlvl 38
		[153, 5, false], // Natural Resistance 5 // charLvl 43
		[133, 15, false], // Double Swing 15 // -> charlvl 49
		[149, 20, false], // Battle Orders 20 // -> charlvl 68*/

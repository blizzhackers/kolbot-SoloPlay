...
(function (factory) {
    ...
    function mixin(target) {
        ...
        sources.forEach(function (source) { return Object.getOwnPropertyNames(source.prototype)
    ...
    function mixinFunctions(target) {
        ...
        sources.forEach(function (source) { return Object.getOwnPropertyNames(source.prototype)
            ...
            var propertyDescriptor = Object.getOwnPropertyDescriptor(source.prototype, key);
            var current = Object.getOwnPropertyDescriptor(target.prototype, key);

    ...
    function moveTo(target, givenSettings) {
        ...
        var searchShrine = function () { return Game.getObject("shrine")
            ...
            .filter(function (el) {
                ...
                var currentIndex = Config.ScanShrines.findIndex(function (s) { return me.getState(stateForShrine(s)); });
                var index = Config.ScanShrines.indexOf(el.objtype);
        ...
        try {
            ...
            var _loop_1 = function (i, node, l) {
                if (settings.allowClearing && settings.clearFilter && canTeleport) {
                    j = i + 1;
                    var monsters = getUnits(sdk_1.default.unittype.Monster)

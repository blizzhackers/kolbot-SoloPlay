...
Cubing.buildRecipes = function () {
	...
	for (let i = 0; i < Config.Recipes.length; i += 1) {
		...
		case Recipe.Unique.Weapon.ToExceptional:
			this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Ral, sdk.items.runes.Sol, sdk.items.gems.Perfect.Emerald], Index: Recipe.Unique.Weapon.ToExceptional, Ethereal: Config.Recipes[i][2], Name: Config.Recipes[i][3]});

			break;
		case Recipe.Unique.Weapon.ToElite: // Ladder only
			if (me.ladder || Developer.addLadderRW) {
				this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Lum, sdk.items.runes.Pul, sdk.items.gems.Perfect.Emerald], Index: Recipe.Unique.Weapon.ToElite, Ethereal: Config.Recipes[i][2], Name: Config.Recipes[i][3]});
			}

			break;
		case Recipe.Unique.Armor.ToExceptional:
			this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Tal, sdk.items.runes.Shael, sdk.items.gems.Perfect.Diamond], Index: Recipe.Unique.Armor.ToExceptional, Ethereal: Config.Recipes[i][2], Name: Config.Recipes[i][3]});

			break;
		case Recipe.Unique.Armor.ToElite: // Ladder only
			if (me.ladder || Developer.addLadderRW) {
				this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Lem, sdk.items.runes.Ko, sdk.items.gems.Perfect.Diamond], Index: Recipe.Unique.Armor.ToElite, Ethereal: Config.Recipes[i][2], Name: Config.Recipes[i][3]});
			}

			break;
		case Recipe.Rare.Weapon.ToExceptional:
			this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Ort, sdk.items.runes.Amn, sdk.items.gems.Perfect.Sapphire], Index: Recipe.Rare.Weapon.ToExceptional, Ethereal: Config.Recipes[i][2], stats: Config.Recipes[i][3]});

			break;
		case Recipe.Rare.Weapon.ToElite:
			this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Fal, sdk.items.runes.Um, sdk.items.gems.Perfect.Sapphire], Index: Recipe.Rare.Weapon.ToElite, Ethereal: Config.Recipes[i][2], stats: Config.Recipes[i][3]});

			break;
		case Recipe.Rare.Armor.ToExceptional:
			this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Ral, sdk.items.runes.Thul, sdk.items.gems.Perfect.Amethyst], Index: Recipe.Rare.Armor.ToExceptional, Ethereal: Config.Recipes[i][2], stats: Config.Recipes[i][3]});

			break;
		case Recipe.Rare.Armor.ToElite:
			this.recipes.push({Ingredients: [Config.Recipes[i][1], sdk.items.runes.Ko, sdk.items.runes.Pul, sdk.items.gems.Perfect.Amethyst], Index: Recipe.Rare.Armor.ToElite, Ethereal: Config.Recipes[i][2], stats: Config.Recipes[i][3]});

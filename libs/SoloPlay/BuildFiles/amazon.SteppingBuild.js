...
let build = {
	...
	active: function () {
		return me.charlvl > Config.respecOne && me.charlvl < Config.respecOneB && Skill.canUse(sdk.skills.LightningStrike) && me.getSkill(sdk.skills.PlagueJavelin, sdk.skills.subindex.hardpoints) <= 5;
	},
};

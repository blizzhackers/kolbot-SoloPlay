...
if (me.getItem(sdk.items.runes.Lo) && me.getItem(sdk.items.runes.Jah)) {
	if (!Check.haveBase("amazonbow", 4)) {
		...
		NTIP.addLine("([name] == grandmatronbow || [name] == wardbow || [name] == bladebow || [name] == diamonbow) && [quality] == normal # [sockets] == 0 # [maxquantity] == 1");
	}

	NTIP.addLine("([name] == grandmatronbow || [name] == wardbow || [name] == bladebow || [name] == diamonbow) && [quality] >= normal && [quality] <= superior # [sockets] == 4 # [maxquantity] == 1");
} else {
